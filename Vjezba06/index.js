...
for(let i = 0; i < niz.length; i++){
    if ((niz[i]%2) != 0){
        console.log(`neparni element niza: ${niz[i]}`);
    }
};
...
//4. Zadatak
niz_lower = ['hawkeye', 'black widow'];
niz_upper = ['CAPTAIN AMERICA', 'IRON MAN', 'HULK', 'THOR'];

niz_copy = niz_lower.copyWithin();
niz_copy = niz_copy.concat(niz_upper);

console.log(`kopija niza: ${niz_copy}`);

//5. Zadatak
const start = 1;
const delete_count = 3;

niz_copy.splice(start, delete_count);

console.log(`kopija niza nakon uklanjanja elemenata: ${niz_copy}`); 